  ...
  return <View style={styles.container}>
      ...
      <View style={styles.chatHeader}>
          ...
          <View style={styles.icons}>
            <Image source={require( // @ts-ignore
          "./assets/call.png")} />
              <Image style={styles.cameraIcon} source={require( // @ts-ignore
          "./assets/camera.png")} />
          </View>
      </View>
      ...
      <View style={styles.sendMessage}>
         <View style={styles.messageBox}>
          ...
          <View style={styles.userBox}>
            <Image style={styles.logoChatIcon} source={require( // @ts-ignore
            "./assets/logo.png")} />
            <Image style={styles.onlineIcon} source={require( // @ts-ignore
            "./assets/Oval.png")} />
          </View>
      </View>
      </View>
      ...
      <View style={styles.chatSection}>
          ...
          <View style={styles.inputIcons}>
            ...
            <Image style={styles.smileyIcon} source={require( // @ts-ignore
          "./assets/smiley.png")} />
            <Image source={require( // @ts-ignore
          "./assets/mic.png")} />
          </View>
          <Image style={styles.sendIcon} source={require( // @ts-ignore
        "./assets/send.png")} />
      </View>
      </ScrollView>
    </View>;
